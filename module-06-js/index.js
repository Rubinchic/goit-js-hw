...
// ___________________Ex3_____________

//  const getUsersWithGender = (users, gender) => {
//      const genders = users.filter(el => el.gender === gender );
//      return genders;
//    };
  
//    console.log(getUsersWithGender(users, 'male')); // [ 'Moore Hensley', 'Ross Vazquez', 'Carey Barr', 'Blackburn Dotson' ]

// ______________Ex4______________

// const getInactiveUsers = users => {
//     const activeUsers = users.filter(element => element.isActive === false);
//     return activeUsers; 
//   };
  
//   console.log(getInactiveUsers(users)); // [объект Moore Hensley, объект Ross Vazquez, объект Blackburn Dotson]

// ________Ex5_____________
...
// _____________________Ex6___________
...
//   __________________________Ex7____________
...
// ______________Ex8________________
